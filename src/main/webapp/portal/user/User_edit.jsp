...
<%}%>
	function doPopOrg() {
		openWin("OrgPop.do?act=list&id_field=amsd_store&name_field=org_name",
				"user_org_pop");
	}
<%String org_id = (String) request.getSession()
					.getAttribute("org_id");%>
...
<body class="body_bg_grey1">
	<html:form method="post" action="User.do">
		...
		<table width="98%" align=center class="dtPanel_Line3" border="0"
			...
			<tr bgcolor="#FFFFFF">
				...
				<td colspan="3" align="left" class="dtPanel_Main2">&nbsp; <html:text
						property="user_id" styleClass="Textfield-READONLY" readonly="true"
						size="16" maxlength="8" />
				</td>
			</tr>

			<tr bgcolor="#FFFFFF">
				<td align="right" class="dtPanel_Left">&nbsp;<%=ViewUtil.must()%>中文姓名：
				</td>
				<td colspan="3" align="left" class="dtPanel_Main2">&nbsp; <html:text
						property="user_name" styleClass="Textfield" size="26"
						maxlength="18" />
				</td>
			</tr>
			...
			<tr bgcolor="#FFFFFF">
				...
				<td colspan="3" align="left" class="dtPanel_Main2">&nbsp; <html:text
						property="login_id" styleClass="Textfield-READONLY"
						readonly="true" size="20" maxlength="10" />
				</td>
			</tr>
			...
			<tr bgcolor="#FFFFFF">
				...
				<td colspan="3" align="left" class="dtPanel_Main2">&nbsp; <html:text
						property="phone" styleClass="Textfield" size="38" maxlength="30" />
				</td>
			</tr>
			...
			<tr bgcolor="#FFFFFF">
				...
				<td colspan="3" align="left" class="dtPanel_Main2">&nbsp; <html:text
						property="mobile" styleClass="Textfield" onkeypress="checknum()"
						onkeyup="onlyNum(this)" size="19" maxlength="11" />
				</td>
			</tr>
			...
			<tr bgcolor="#FFFFFF">
				...
				<td colspan="3" align="left" class="dtPanel_Main2">&nbsp; <html:text
						property="email" styleClass="Textfield" size="62" maxlength="60" />
				</td>
			</tr>

			<tr bgcolor="#FFFFFF">
				<td align="right" class="dtPanel_Left">&nbsp;员工编号：</td>
				<td colspan="3" align="left" class="dtPanel_Main2">&nbsp; <html:text
						property="postcode" styleClass="Textfield" size="20"
						maxlength="20" />
				</td>
			</tr>
			<tr bgcolor="#FFFFFF">
				<td align="right" class="dtPanel_Left">&nbsp;所属部门：</td>
				<td colspan="3" align="left" class="dtPanel_Main2">&nbsp; <html:select
						property="depart_id">
						<html:optionsCollection name="userForm" property="departs" />
					</html:select>
				</td>
			</tr>
			<tr bgcolor="#FFFFFF">
				...
				<td colspan="3" align="left" class="dtPanel_Main2">&nbsp; <html:text
						property="address" styleClass="Textfield" size="62"
						maxlength="200" />
				</td>
			</tr>

			<tr bgcolor="#FFFFFF">
				<td align="right" class="dtPanel_Left" rowspan="2">&nbsp;用户角色：</td>
				<td align="center">可选角色</td>
				<td width=70 align="center">&nbsp;</td>
				<td align="center"><%=ViewUtil.must()%>已选角色</td>
			</tr>
			<tr bgcolor="#FFFFFF">
				<td align="center"><select name="rolesLeft" id="rolesLeftId"
					size="14" multiple="multiple">
						<%
							//从action层获得用户可以选择但未选择的角色权限集合
								List rolesNotSelected = (ArrayList) request
										.getAttribute("rolesNotSelected");
				...
				<td align="center"><input type='button' class='Button'
					name="ad"
					onClick='moveItems(document.forms[0].rolesLeft,document.forms[0].rolesRight,"selected")'
					value='增加 >'><br> <br> <input type='button'
					name="ad" class='Button'
					onClick='moveItems(document.forms[0].rolesRight,document.forms[0].rolesLeft,"selected")'
					value='< 删除 '><br> <br> <input type='button'
					class='Button' name="ad"
					onClick='moveItems(document.forms[0].rolesLeft,document.forms[0].rolesRight,"all")'
					value='全增加>>'><br> <br> <input type='button'
					class='Button' name="ad"
					onClick='moveItems(document.forms[0].rolesRight,document.forms[0].rolesLeft,"all")'
					value='<<全删除'></td>

				<td valign="top" align="center"><select name="rolesRight"
					id="rolesRightId" size="11" multiple class="Select-Multiple"
					style="width: 150">
						<%
							//从action层获得用户已选择的角色权限集合	
								List rolesSelected = (ArrayList) request
										.getAttribute("rolesSelected");
						...
						%>
				</select><br> <input type="button" style="width: 149" class=Button5
					onClick="moveOneSelectedToText(document.forms[0].rolesRight,document.forms[0].role_name,document.forms[0].role_id)"
					value="设为主角色"><br> <%=ViewUtil.must()%>主角色
					 <input type=text name="role_name" readonly class="Textfield-READONLY"
					size="15" value="<%=ReDefSDicMap.getDicItemVal("0002", userForm.getRole_id())%>"/> <html:hidden property="role_id" /></td>
			</tr>

			<tr bgcolor="#FFFFFF">
				<td align="right" class="dtPanel_Left">&nbsp;<%=ViewUtil.must()%>起始日期：
				</td>
				<td align="left" class="dtPanel_Main2">&nbsp; <html:text
						property="begin_dt" styleClass="Textfield" onkeypress="checknum()"
						onkeyup="onlyNum(this)" size="8" maxlength="8" />
					&nbsp;（格式：yyyymmdd）
				</td>
				<td width="18%" align="right" class="dtPanel_Left">&nbsp;<%=ViewUtil.must()%>失效日期：
				</td>
				<td align="left" class="dtPanel_Main2">&nbsp; <%
 	String collCheck = (String) request.getAttribute("collCheck");
 		if (collCheck != null && collCheck.equals("0")) {
 %> <html:text property="invalid_dt" styleId="invalid_dt"
						onkeypress="checknum()" onkeyup="onlyNum(this)"
						styleClass="Textfield-READONLY" readonly="true" size="8"
						maxlength="8" value="20991231" /> <%
 	} else {
 %> <html:text
						property="invalid_dt" styleId="invalid_dt" onkeypress="checknum()"
						onkeyup="onlyNum(this)" styleClass="Textfield" size="8"
						maxlength="8" /> <%
 	}
 %> &nbsp;（格式：yyyymmdd）
				</td>
			...
			<tr bgcolor="#FFFFFF">
				...
				<td colspan="3" align="left" class="dtPanel_Main2">&nbsp; <html:text
						property="modify_dt" onkeyup="onlyNum(this)"
						styleClass="Textfield-READONLY" readonly="true" size="8"
						maxlength="8" />
				</td>
			</tr>
			...
			<tr bgcolor="#FFFFFF">
				...
				<td colspan="3" align="left" class="dtPanel_Main2">&nbsp; <html:text
						property="memo" styleClass="Textfield" size="62" maxlength="200" />
				</td>
			</tr>
		</table>
		...
		<table align=center width="98%" border="0" cellspacing="0"
			...
			<tr>
				<td height="25" align="center" class="dtPanel_Bottom"><input
					...
					onClick="doSave()"> &nbsp; <html:reset value="重置"
						styleClass="Button" /> &nbsp; <input name="return" type="button"
					class="Button" value="返回"
					onClick="location.href='User.do?act=list';"></td>
			</tr>
		</table>
