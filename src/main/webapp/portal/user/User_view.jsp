...
<html:form method="post" action="User.do"> 
    ...
    <table align="center" width="98%"   class="dtPanel_Line3" border="0" cellspacing="1" cellpadding="0">       
        ...
        <tr bgcolor="#FFFFFF">        
          ...
          <td width="25%" align="right" class="dtPanel_Left_v">&nbsp;员工编号：</td> 
          <td width="25%" align="left" class="dtPanel_Main">&nbsp;<%=userForm.getPostcode()%></td> 
          
         </tr> 
 
        <tr bgcolor="#FFFFFF">          
           <td width="25%" align="right" class="dtPanel_Left_v">&nbsp;所属部门：</td> 
          <td  align="left" class="dtPanel_Main">&nbsp;<%=SingleDicMap.getDicItemVal(SingleDic.DEPART, userForm.getDepart_id())%></td>
          <td width="25%" align="right" class="dtPanel_Left_v">&nbsp;联系地址：</td> 
          <td  align="left" class="dtPanel_Main">&nbsp;<%=userForm.getAddress()%></td>
