	...
	<%
		...
		if(list != null ) {
			...
			while (iter.hasNext()) {
				...
				url=(vo.getMenu_url()==null?"":vo.getMenu_url()).trim();
...
//	d.add(90000009,0, '缺陷管理', 'http://yak/mantis', '', '_blank','images/menuImg/leaf.gif');
//	d.add(90000010,0, 'Wiki', 'http://yak/wiki', '', '_blank','images/menuImg/leaf.gif');
