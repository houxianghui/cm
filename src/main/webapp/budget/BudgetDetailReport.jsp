...
function doQuery() { 
	...
	//检查输入查询条件 
 	if(isEmpty($(":input[name='budgetKind']").val())){
 		alert('请选择预算类别');
 	}
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0"> 
          ...
          <tr class="dtPanel_Top02"> 
            ...
            <html:select property="budgetKind"> 
	         	<html:optionsCollection name="budgetDetailForm" property="budget_kind_options" />               
	        </html:select>  &nbsp;&nbsp;
            <td>&nbsp;部门：
            <html:select property="depart_f"> 
	         	<html:optionsCollection name="budgetDetailForm" property="depart_f_options" />               
	        </html:select>  &nbsp;&nbsp;
			项目编号：<html:text property="project_f" styleClass="Textfield" size="20" maxlength="20" />&nbsp;&nbsp;
			费用类别：
            <html:select property="feeKind_f"> 
	         	<html:optionsCollection name="budgetDetailForm" property="fee_kind_options" />               
	        </html:select>&nbsp;&nbsp;
	                            日期从：<html:text property="regDate_from" styleClass="Textfield" size="8" maxlength="8" />&nbsp;&nbsp;
