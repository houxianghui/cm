...
<html:form method="post" action="DatabaseChg.do"> 
...
<%=ViewUtil.getTitle("数据库变更维护")%> 
    ...
    <table align="center" width="98%" class="dtPanel_Line3" border="0" cellspacing="1" cellpadding="0"> 
		...
		<tr bgcolor="#FFFFFF"> 
          <td width="35%" align="right" class="dtPanel_Left">&nbsp; 数据库表：</td> 
        ...
        <tr bgcolor="#FFFFFF"> 
         ...
         <html:select property="subSys">
         	<html:optionsCollection name="databaseChgForm" property="subSysCollection"/>
         </html:select>
         </td>
       </tr>
        <tr bgcolor="#FFFFFF"> 
         ...
         <td align="left" class="dtPanel_Main2">&nbsp; 
			<html:select property="chgType">
				<html:optionsCollection name="databaseChgForm" property="chgTypeCollection"/>
			</html:select>
         </td>
       </tr>
        <tr bgcolor="#FFFFFF"> 
          <td width="35%" align="right" class="dtPanel_Left">&nbsp; 脚本：</td> 
         <td align="left" class="dtPanel_Main2">&nbsp; 
