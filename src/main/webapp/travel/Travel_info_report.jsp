...
function doEdit(){ 
	//修改 
	//检查是否有选中的纪录 
	if(document.forms[0].travelId.value == null ||document.forms[0].travelId.value == "") { 
		alert('请先选择纪录'); 
		return; 
	} 
	//提交表单 
...
function setPKey(travel_id_var) { 
	document.forms[0].travelId.value=travel_id_var; 
} 
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0"> 
          ...
          <tr class="dtPanel_Top02"> 
			...
			到：<html:text property="regDate_to" styleClass="Textfield" size="8" maxlength="8" />&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<html:optionsCollection name="travelInfoForm" property="staffCollection"/>
			</html:select>&nbsp;&nbsp;&nbsp;&nbsp;
