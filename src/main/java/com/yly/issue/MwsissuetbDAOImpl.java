...
public class MwsissuetbDAOImpl extends SqlMapClientDaoSupport implements MwsissuetbDAO {
    ...
    public int getMyIssueTask(String userid) {
        Integer count = (Integer)  getSqlMapClientTemplate().queryForObject("mwsissuetb.getMyIssueTask", userid);
        return count.intValue();
    }
    ...
    public List getReport(String taskCtrlNo) {
        List list = getSqlMapClientTemplate().queryForList("mwsissuetb.getReport", taskCtrlNo);
        return list;
    }
