...
public class ReDefSDicMap {
	...
	*/
	...
	public static String getRadioWithHiddenIdFun(String radioName, String typeID, String tagVal,String hiddenId,String func) {
	...
	*/
	...
	public static String getListCheckBox(List unitlist,String fieldName) {
		StringBuffer checkbox = new StringBuffer("");
		String itemID="";
		String itemValue="";
		for (int i=0;i<unitlist.size();i++) {
			itemID = String.valueOf(((Biunitinfotb)unitlist.get(i)).getUnitid());
			itemValue = ((Biunitinfotb)unitlist.get(i)).getUnitdes();
			checkbox.append(
					"<input name=\""
						+ fieldName
						+ "\" type=\"checkbox\" class=\"Checkbox\" value=\""
	...
	public static String getRadioWithFunHidden(String radioName, String typeID, String tagVal,String hiddenId, String func) {
