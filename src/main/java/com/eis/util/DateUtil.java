...
public final class DateUtil {
	...
	*/
	...
	public static String format(String date,String split){
		...
		return date.substring(0,4)+split+date.substring(4,6)+split+date.substring(6);
	}
	...
	public static void main(String[] args) { 
		System.out.println(toStringHex("3844303835423333"));
	} 
